...
//        REQUIRE( matrix_result.GetValueAt(0,2) == (a00 * b01) + (a01 * b11) );
//        REQUIRE( matrix_result.GetValueAt(1,0) == (a10 * b00) + (a11 * b10) );
//        REQUIRE( matrix_result.GetValueAt(1,1) == (a10 * b01) + (a11 * b11) );
//        REQUIRE( matrix_result.GetValueAt(1,2) == (a10 * b01) + (a11 * b11) );
//        REQUIRE( matrix_result.GetValueAt(2,0) == (a20 * b00) + (a11 * b10) );
//        REQUIRE( matrix_result.GetValueAt(2,1) == (a20 * b01) + (a11 * b11) );
//        REQUIRE( matrix_result.GetValueAt(2,2) == (a20 * b01) + (a11 * b11) );
